...
db = "delta_adb_essentials_amineben"
...
# MAGIC %fs
# MAGIC ls /databricks-datasets/samples/lending_club
...
# MAGIC %sql
# MAGIC SELECT *, length(addr_state) FROM loan_by_state_delta
...
# MAGIC %md ## ![Delta Lake Tiny Logo](https://pages.databricks.com/rs/094-YMS-629/images/delta-lake-tiny-logo.png) Wirting into Delta Lake format
...
# MAGIC CREATE TABLE loan_stats USING DELTA LOCATION '/adbessentials/loan_stats';
